    ...
    const loadLesson = async () => {
        ...
        try {
            ...
            if (lesson) {
                ...
                let files: Array<{ id: string; name: string; url: string; type: string; uploadedBy?: string; uploadedByName?: string; note?: string }> = [];
                ...
                setFormData({
                    ...
                    attendanceChecked: lesson.attendanceChecked ?? false,
                    files: files
                });
            } else {
